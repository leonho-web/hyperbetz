...
export function LiveChatSidebar() {
	...
	return (
		<div
			ref={sidebarRef}
			className="fixed right-0 top-16 bottom-0 w-full lg:w-96 z-50 shadow-2xl flex flex-col bg-sidebar border-l border-sidebar-border backdrop-blur-xl overflow-hidden ios-chat-sidebar"
			style={{
