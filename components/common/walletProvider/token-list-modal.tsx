...
// 		// If there's a search query, show filtered results from all tokens
// 		if (searchQuery) {
...
// 			owned.sort((a, b) => {
// 				// Sort OWNED tokens by their fiat value in DESCENDING order.
// 				// const valueA = parseFloat(a.balance) * parseFloat(a.usd_price);
// 				// const valueB = parseFloat(b.balance) * parseFloat(b.usd_price);

// 				// Sort OWNED tokens by their balance in DESCENDING order.
// 				const valueA = parseFloat(a.balance);
// 				const valueB = parseFloat(b.balance);
...
// 		// If no search query, only show tokens with balance > 0
...
// 					<CommandList className="flex-grow px-2 max-h-full">
// 						{!isLoading &&
// 							!showSearchResults &&
...
// 									</CommandGroup>
// 								)}
// 								{/* Only show other tokens when searching */}
